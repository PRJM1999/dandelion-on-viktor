...
def test_post_init_ip_units(hourly_data):
    ...
    assert hourly_data.convert_to_si.call_count == 5, "convert_to_si should be called for each attribute"
...
def test_convert_to_si(hourly_data):
    ...
    assert hourly_data.convert_to_si.call_count == 5, "convert_to_si should be called for each attribute after method call"
...
def test_convert_to_ip(hourly_data):
    ...
    data.convert_to_ip()
    assert hourly_data.convert_to_ip.call_count == 5, "convert_to_ip should be called for each attribute after method call"
